...
namespace NeeView.Setting
{
    public class SettingPagePanels : SettingPage
    {
        ...
        public SettingPagePanels() : base(Properties.Resources.SettingPage_Panels)
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.AutoHide, nameof(AutoHideConfig.AutoHideConfrictTopMargin))));
    ...
    public class SettingPageSlider : SettingPage
    {
        public SettingPageSlider() : base(Properties.Resources.SettingPage_Slider)
        {
            ...
            section.Children.Add(new SettingItemProperty(PropertyMemberElement.Create(Config.Current.Slider, nameof(SliderConfig.Color))));
