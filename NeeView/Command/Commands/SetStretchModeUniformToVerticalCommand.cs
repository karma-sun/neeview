...
namespace NeeView
{
    public class SetStretchModeUniformToVerticalCommand : CommandElement
    {
        ...
        {
            return this.Text + (ViewComponentProvider.Current.GetViewController(sender).TestStretchMode(PageStretchMode.UniformToVertical, ((StretchModeCommandParameter)e.Parameter).IsToggle) ? "" : " OFF");
        }
        ...
        {
            ViewComponentProvider.Current.GetViewController(sender).SetStretchMode(PageStretchMode.UniformToVertical, ((StretchModeCommandParameter)e.Parameter).IsToggle);
        }
    }
}
