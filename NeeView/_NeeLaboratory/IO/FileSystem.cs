...
namespace NeeLaboratory.IO
{
    ...
    public class FileSystem
    {
        ...
        private static void InitializeDefaultResource()
        {
            ...
            _folderTypeName = GetTypeNameWithAttribute(path, NativeMethods.FILE_ATTRIBUTE_DIRECTORY);
            _folderIcon = GetTypeIconSourceWithAttribute(path, IconSize.Small, NativeMethods.FILE_ATTRIBUTE_DIRECTORY);
