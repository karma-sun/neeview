...
namespace NeeView
{
    public class SetStretchModeUniformToVerticalCommand : CommandElement
    {
        ...
        {
            return this.Text + (ContentCanvas.Current.TestStretchMode(PageStretchMode.UniformToVertical, ((StretchModeCommandParameter)e.Parameter).IsToggle) ? "" : " OFF");
        }
        ...
        {
            ContentCanvas.Current.SetStretchMode(PageStretchMode.UniformToVertical, ((StretchModeCommandParameter)e.Parameter).IsToggle);
        }
    }
}
