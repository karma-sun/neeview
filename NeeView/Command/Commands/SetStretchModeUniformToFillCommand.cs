...
namespace NeeView
{
    public class SetStretchModeUniformToFillCommand : CommandElement
    {
        ...
        {
            return this.Text + (ViewComponentProvider.Current.GetViewController(sender).TestStretchMode(PageStretchMode.UniformToFill, ((StretchModeCommandParameter)e.Parameter).IsToggle) ? "" : " OFF");
        }
        ...
        {
            ViewComponentProvider.Current.GetViewController(sender).SetStretchMode(PageStretchMode.UniformToFill, ((StretchModeCommandParameter)e.Parameter).IsToggle);
        }
    }
}
