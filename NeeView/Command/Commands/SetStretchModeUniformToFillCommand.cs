...
namespace NeeView
{
    public class SetStretchModeUniformToFillCommand : CommandElement
    {
        ...
        {
            return this.Text + (ViewComponent.Current.ViewController.TestStretchMode(PageStretchMode.UniformToFill, ((StretchModeCommandParameter)e.Parameter).IsToggle) ? "" : " OFF");
        }
        ...
        {
            ViewComponent.Current.ViewController.SetStretchMode(PageStretchMode.UniformToFill, ((StretchModeCommandParameter)e.Parameter).IsToggle);
        }
    }
}
