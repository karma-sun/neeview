...
namespace NeeView
{
    public class SetStretchModeUniformToSizeCommand : CommandElement
    {
        ...
        {
            return this.Text + (ViewComponentProvider.Current.GetViewController(sender).TestStretchMode(PageStretchMode.UniformToSize, ((StretchModeCommandParameter)e.Parameter).IsToggle) ? "" : " OFF");
        }
        ...
        {
            ViewComponentProvider.Current.GetViewController(sender).SetStretchMode(PageStretchMode.UniformToSize, ((StretchModeCommandParameter)e.Parameter).IsToggle);
        }
    }
}
